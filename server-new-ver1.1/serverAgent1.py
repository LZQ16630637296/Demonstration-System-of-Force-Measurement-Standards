...
class ServerAgent():
    ...
    def connect_mqtt(
        ...
        def on_connect(client, userdata, flags, rc):
            ...
            # 响应状态码为0表示连接成功
            if rc == 0:
                print("cloud Connected to MQTT OK!")
            else:
    ...
    def getInfo(
        ...
        if self.virtual_res:
            ...
            if topic == 'mqtt/system/CPUFLOPS':
                ...
                msg = self.clientID + ':' + str(round(getMEMInfo()[0], 2)) + 'GB'
                return msg
            elif topic == 'mqtt/system/External_storage':
                msg = self.clientID + ':' + str(round(getDiskInfo()[0], 2)) + 'GB'
                return msg
            elif topic == 'mqtt/system/Cache':
            ...
            # TODO:消息处理（多类
                ...
                str3 = str(round(self.res.Node.config.getMemoryByte_M('Cache'), 2)) + 'GB'  # cache 没有总大小，它是根据负载动态变化的
                msg = self.clientID + ':' + str1 + ':' + str2 + ':' + str3
                return msg
